...
// const FinanceMenu = [
//   { label: "dashboard", to: "/financedash" },
//   { label: "fin", to: "/policy" },
//   { label: "Fin", to: "/claims" },
...
// const FinSidebar: React.FC<SidebarProps> = ({ open, onClose }) => {
// //   const { user } = useAuth();
...
const FinanceSidebar: React.FC<SidebarProps> = (props) => {
  return <Sidebar {...props} role="finance" />;
};
