...
import UserManagementHeader from "../../../../components/AdminUsermanagment/UserManagementHeader";
import RoleTabsSection from "../../../../components/AdminUsermanagment/RoleTabsSection";
import SearchFilterSection from "../../../../components/AdminUsermanagment/SearchFilterSection";
import UserTableSection from "../../../../components/AdminUsermanagment/UserTableSection";
import StatsSummary from "../../../../components/AdminUsermanagment/StatsSummary";
import MobileHeader from "../../../../components/AdminUsermanagment/MobileHeader";
...
const UserManagementPage: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-amber-50/50 to-yellow-50/50">
      ...
      <main className="flex-1 md:ml-64 pt-16 md:pt-0">
        <div className="p-6">
          <UserManagementHeader usersCount={users.length} />
