...
// // Top Navigation Bar for Customer
// // const TopBar = lazy(() => import('../components/Bars/TopBar'));
// const CustomerTopNav = lazy(() => import('../components/Bars/TopBar/CustomerTopNav'));
...
//       case 'customer': return CustomerSidebar as unknown as React.LazyExoticComponent<React.ComponentType<Record<string, unknown>>>;
...
const ProtectedRouteWrapper: React.FC<ProtectedRouteWrapperProps> = ({ 
  ...
  const getSidebarComponent = (): React.LazyExoticComponent<React.ComponentType<Record<string, unknown>>> => {
    switch (role) {
      case 'admin': return AdminSidebar as unknown as React.LazyExoticComponent<React.ComponentType<Record<string, unknown>>>;
      case 'customer': return CustomerSidebar as unknown as React.LazyExoticComponent<React.ComponentType<Record<string, unknown>>>;
      case 'finance': return FinanceSidebar as unknown as React.LazyExoticComponent<React.ComponentType<Record<string, unknown>>>;
      case 'manager': return ManagerSidebar as unknown as React.LazyExoticComponent<React.ComponentType<Record<string, unknown>>>;
      case 'operator': return OperatorSidebar as unknown as React.LazyExoticComponent<React.ComponentType<Record<string, unknown>>>;
      default: return AdminSidebar as unknown as React.LazyExoticComponent<React.ComponentType<Record<string, unknown>>>;
    }
  };
